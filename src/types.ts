// Here, RootStackParamList is a TypeScript type that you would define elsewhere in your app to map screen names to their respective navigation parameters. For example:
